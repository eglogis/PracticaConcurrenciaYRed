...
class TopicDetailViewController: UIViewController {
    ...
    override func loadView() {
        ...
        deleteBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "trash"), style: .plain, target: self, action: #selector(deleteButtonTapped))
    ...
    fileprivate func showErrorFetchingTopicDetailAlert(title: String) {
...
extension TopicDetailViewController: TopicDetailViewDelegate {
    func errorDeleteTopic() {
        showErrorFetchingTopicDetailAlert(title: "Error delete topic\nPlease try again later")
    }

    func topicDetailFetched(title: String, id: Int, canDelete: Bool) {
        labelTopicID.text = String(id)
        labelTopicTitle.text = title
        navigationItem.rightBarButtonItem = canDelete ? deleteBarButtonItem : nil
    }

    func errorFetchingTopicDetail() {
        showErrorFetchingTopicDetailAlert(title: "Error fetching topic detail\nPlease try again later")
    }
}
